...
Muto is a lightweight little ruby/vbs/bat script that I put together that will allow you to change the version of Ruby that your system is using by
modifying systems User Environment variables. You can do this with Muto without having to reload your command prompt/shell and all of your gem paths etc
...
variables at the same time. In the following example I've added the ability to use JRuby164 with either Java Runtime 6 or Java Runtime 7
...
supported_versions:
  ruby_186:
    ...
    other_variables:
      home: C:\ruby\homepath
  ruby_192:
    shortcut: 192
    bin_folder: C:\ruby192\bin
    other_variables:
      home: C:\ruby192\homepath
